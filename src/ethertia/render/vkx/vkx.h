...
namespace vkx
{
    ...
    public:
        ...
        VkSampler ImageSampler{};  // default sampler. VK_FILTER_NEAREST, VK_SAMPLER_ADDRESS_MODE_REPEAT
        VkDescriptorPool DescriptorPool{};
        ...
        VkRenderPass MainRenderPass{};  // external. main render pass.
...
//}
    ...
    public:
        ...
        bool isIndexed() const { return idxbuffer() != 0; }
